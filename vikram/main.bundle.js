...
var Story1Component = (function () {
  ...
  getCharacterOffsetWithin(range, node) {
    ...
    Story1Component.prototype.onDescriptionInput = function (e) {
        $('.list2').css('top', (e.clientY + 5 + 'px')).show();
    };
